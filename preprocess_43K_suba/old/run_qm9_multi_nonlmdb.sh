...
#SBATCH -p gpu_p6
#SBATCH -C h100
#SBATCH -J train_qm9_multi_nonlmdb
#SBATCH -t 18:00:00
#SBATCH -N 1
#SBATCH --ntasks=1
...
# Outputs
export PERSIST_RUN_DIR="/lustre/fsn1/projects/rech/ihj/$USER/qtaim_embed_private/logs_suba/train_qm9_multi_nonlmdb_${SLURM_JOB_ID}"
...
# Config
SRC_CFG="/lustre/fsn1/projects/rech/ihj/$USER/qtaim_embed_private/configs_suba/settings_qm9_nonlmdb.json"
if [[ ! -f "$SRC_CFG" ]]; then
...
LOC_CFG="${JOBSCRATCH:-/tmp}/${USER}/configs_suba/settings_qm9_nonlmdb_local.json"
...
srun --cpu-bind=none python -u -m qtaim_embed.scripts.train.train_qtaim_graph_nonlmdb \
  -config "${LOC_CFG}" \
  -project_name "qm9_qtaim_multi_nonlmdb" \
