...
mkdir -p /lustre/fsn1/projects/rech/ihj/urb54jd/qtaim_embed_private/logs_suba
ls -ld /lustre/fsn1/projects/rech/ihj/urb54jd/qtaim_embed_private/logs_suba
...
export PYTHONPATH=/lustre/fsn1/projects/rech/ihj/urb54jd/qtaim_embed_private:$PYTHONPATH

# === Output folders ===
export PERSIST_RUN_DIR="/lustre/fsn1/projects/rech/ihj/urb54jd/qtaim_embed_private/logs_suba/train_qm9_multi_nonlmdb_43k_${SLURM_JOB_ID}"
...
# === Config ===
SRC_CFG="/lustre/fsn1/projects/rech/ihj/urb54jd/qtaim_embed_private/configs_suba/settings_qm9_nonlmdb_43k.json"
...
LOC_CFG="${JOBSCRATCH:-/tmp}/urb54jd/configs_suba/settings_qm9_nonlmdb_43k.json"
mkdir -p "$(dirname "$LOC_CFG")"

export SRC_CFG LOC_CFG LOG_DIR OVERRIDE_TRAIN OVERRIDE_TEST
