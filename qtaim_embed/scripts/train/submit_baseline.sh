...
#SBATCH -p gpu_p6
#SBATCH -C h100
#SBATCH -J train_sota_baseline_corrected
#SBATCH -t 18:00:00
#SBATCH -N 1
...
#working directory where script and configs are
cd /lustre/fsn1/projects/rech/ihj/$USER/qtaim_embed_private

# Run outputs
PERSIST_RUN_DIR="/lustre/fsn1/projects/rech/ihj/$USER/qtaim_embed_private/logs_suba/train_43k_baseline_corrected${SLURM_JOB_ID}"
...
# call the script directly, not as a module
