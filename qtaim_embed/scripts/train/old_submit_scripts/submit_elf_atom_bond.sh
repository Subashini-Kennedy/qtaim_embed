#!/bin/bash
# =======================================================================
# submit_elf_atom_bond.sh
# Option C: SOTA baseline graph + ELF features on atom AND bond nodes
...
#SBATCH -p gpu_p6
#SBATCH -C h100
#SBATCH -J train_qm9_elf_atom_bond
#SBATCH -t 48:00:00
...
PERSIST_RUN_DIR="/lustre/fsn1/projects/rech/ihj/$USER/qtaim_embed_private/logs_suba/train_qm9_elf_atom_bond_${SLURM_JOB_ID}"
...
srun --ntasks-per-node=1 --cpu-bind=none python -u \
  ...
  -dataset_test_loc "/lustre/fsn1/projects/rech/ihj/$USER/qtaim_embed_private/data_suba/filtered_qtaim_fullqm9_elf/option_c_atom_bond_elf/test_43k_elf.pkl" \
